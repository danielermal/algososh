...
export const Circle: React.FC<CircleProps> = ({
  ...
  return (
    <div className={`${styles.content} ${extraClass}`} data-testid="circle-box" >
      <div
      ...
      <div
        data-testid={ElementStates.Default ? "circle" : ElementStates.Modified ? "circle-modified" : "circle-changing"}
